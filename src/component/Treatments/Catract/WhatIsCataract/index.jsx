...
export default function WhatIsCataractSection({ content }) {
  ...
  return (
    <section className={styles.section} aria-labelledby="what-is-cataract-title" ref={sectionRef}>
      <div className={styles.inner}>
        <span className={styles.badge}>{content.badge}</span>

        <div className={styles.headerRow}>
          <div className={styles.titleWrap}>
            <h2 id="what-is-cataract-title" className={playfairDisplay.className}>
              {content.title}
            </h2>
          </div>

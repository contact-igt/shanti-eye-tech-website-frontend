...
export default function CatractHero({ content }) {
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  return (
    <article className={styles.page}>
      <section className={styles.hero} aria-labelledby="catract-hero-title">
        <Image
        ...
        <div className={styles.heroCopy}>
          <h1 id="catract-hero-title" className={playfairDisplay.className}>

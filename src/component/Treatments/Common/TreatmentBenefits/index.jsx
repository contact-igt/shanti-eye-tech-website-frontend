...
export default function TreatmentBenefits({ content }) {
  ...
  return (
    <section
      ...
      id={content.id}
      aria-labelledby={content.headingId || "treatment-benefits-title"}
    >
      <Image
      ...
      >
        <motion.div className={styles.heading} variants={stagger}>
          ...
          <motion.h2 id={content.headingId || "treatment-benefits-title"} variants={reveal}>
            {content.title}
          </motion.h2>
